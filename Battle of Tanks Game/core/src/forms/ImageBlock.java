...
public class ImageBlock implements Disposable {
	...
	private void initBackground () {
		...
		background.setPosition(CameraController.getInstance().getWidth() - background.getWidth() - 50, CameraController.getInstance().getHeight() - background.getHeight() - 70);
		
		tank1 = new Sprite(new Texture(Gdx.files.internal("images/tank1.png")));
		tank2 = new Sprite(new Texture(Gdx.files.internal("images/tank2.png")));
		tank3 = new Sprite(new Texture(Gdx.files.internal("images/tank3.png")));
		tank4 = new Sprite(new Texture(Gdx.files.internal("images/tank4.png")));
		...
		logo.setPosition(CameraController.getInstance().getWidth() / 2 - logo.getWidth() / 2, 300);
	}
