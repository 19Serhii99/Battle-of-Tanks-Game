...
public class Font implements Disposable {
	...
	private FreeTypeFontGenerator freeTypeFontGeneratorItalic;
	...
	private Font () {
		...
		freeTypeFontGeneratorItalic = new FreeTypeFontGenerator(Gdx.files.internal("fonts/fontItalic.ttf"));
		initLanguages();
	}
	...
	public BitmapFont generateBitmapFontItalic (Color color, int size) {
		FreeTypeFontParameter freeTypeFontParameter = new FreeTypeFontParameter();
		freeTypeFontParameter.size = size;
		freeTypeFontParameter.characters = chars;
		freeTypeFontParameter.color = color;
		return freeTypeFontGeneratorItalic.generateFont(freeTypeFontParameter);
	}
	...
	public void dispose () {
		if (font != null) {
			...
			freeTypeFontGeneratorItalic.dispose();
		}
	}
}